...
void Game1()
{
    ...
    else if(PositionX>=1 && PositionX<=15 && PositionY>=140 && PositionY<=200 && Compass>=0 && Compass<=180)
    {
        Duration = 5;
        CurAction =4;
    }
...
if (Compass > 90 && Compass < 270) {
 ...
 WheelRight = 2;
        ...
        case 5:
            ...
            LED_1=0;
            MyState=0;
            if (PositionY>140 && PositionY<200){
 WheelLeft=1;
...
if (sqrt(abs(PositionX-target_x)*abs(PositionX-target_x)+abs(PositionY-target_y)*abs(PositionY-target_y))<20){
if(Compass < target_angle && abs(Compass + 360 - target_angle) <= abs(Compass - target_angle)){
WheelLeft = 3;
...
if(PositionX>target_x-6  && PositionX < target_x+6 && PositionY> target_y-6 && PositionY< target_y+6){
 act=3;
